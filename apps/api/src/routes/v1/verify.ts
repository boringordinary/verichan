...
const verifyTokenParams = t.Object({
  token: t.String(),
});
...
export const verifyRouter = new Elysia({ prefix: "/v1/verify" })
  ...
  .get(
    ...
    },
    {
      ...
      detail: {
        summary: "Get hosted verification session",
        description: "Looks up a verification session by hosted-flow token for the public verification UI.",
        tags: ["Hosted Verify"],
      },
    },
  );
